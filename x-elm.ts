...
import {Actions, AP, ProAP} from './ts-refs/xtal-element/types.js';
...
import { Infractions, PropInfo } from './ts-refs/trans-render/froop/types.js';

export class XElm extends O implements Actions{
    ...
    async define(self: this){
        const {aka, mainTemplate, assumeCSR, inferProps, xform,
            propInfo, propDefaults, shadowRootMode, inherits, actions, styles, fa, compacts
        } = self;
...
export interface XElm extends AP{}